  ...
  return (
    <>
      <div className="flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px-24">
        {/* Left Screen : Room Listings */}
        <div>
          <div className={`flex flex-col items-start text-left`}>
            <h1 className={`text-4xl md:text-[40px] font-playflair`}>
              Hotel Rooms
            </h1>
            ...
            >
              ...
              <div className="md:w-1/2 flex flex-col gap-2">
                ...
                <p
                  ...
                  className="text-gray-800 text-3xl font-playflair cursor-pointer"
                >
                  {room.hotel.name}
                </p>
