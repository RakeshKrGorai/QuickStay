...
function AddRoom() {
  // useState initialised with {} because for adding room 4 images will be needed, hence an object to take all 4 images at once.
      ...
      <div className="w-full flex max-sm:flex-col sm:gap-4 mt-4">
        ...
        <div className="flex-1 max-w-48">
          ...
          >
            ...
            <option value={"Doubly Bed"}>Doubly Bed</option>
